	...
	>
		<div className="flex items-center justify-between gap-2 py-1">
			...
			<button
				...
				className="max-sm:hidden flex gap-1.5 items-center px-4 py-2.5 rounded-full text-black font-semibold text-sm transition-opacity duration-200 hover:opacity-85 ml-1"
